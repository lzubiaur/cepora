...
/* Binding options
 * CPR__GLFW_CLIPBOARD_BIND
 * CPR__GLFW_CREATE_CURSOR_BIND
 * CPR__GLFW_ERROR_HANDLING_BIND
 * CPR__GLFW_INPUT_MODE_BIND
 * CPR__GLFW_JOYSTICK_BIND
 * CPR__GLFW_KEYBOARD_BIND
 * CPR__GLFW_MANUAL_EXT_LOADING_BIND
 * CPR__GLFW_MONITOR_BIND
 * CPR__GLFW_MONITOR_MODE_BIND
 * CPR__GLFW_MOUSE_BIND
 * CPR__GLFW_MOUSE_CALLBACK_BIND
 * CPR__GLFW_TIME_BIND
 * CPR__GLFW_VERSION_BIND
 * CPR__GLFW_WINDOW_CALLBACKS_BIND
 * CPR__GLFW_WINDOW_EXTRA_BIND
 */

/* Enable all features binding */
#if defined(CPR_GLFW_ALL)
#define CPR__GLFW_CLIPBOARD_BIND
#define CPR__GLFW_CREATE_CURSOR_BIND
#define CPR__GLFW_ERROR_HANDLING_BIND
#define CPR__GLFW_INPUT_MODE_BIND
#define CPR__GLFW_JOYSTICK_BIND
#define CPR__GLFW_KEYBOARD_BIND
#define CPR__GLFW_MANUAL_EXT_LOADING_BIND
#define CPR__GLFW_MONITOR_BIND
#define CPR__GLFW_MONITOR_MODE_BIND
#define CPR__GLFW_MOUSE_BIND
#define CPR__GLFW_MOUSE_CALLBACK_BIND
#define CPR__GLFW_TIME_BIND
#define CPR__GLFW_VERSION_BIND
#define CPR__GLFW_WINDOW_CALLBACKS_BIND
#define CPR__GLFW_WINDOW_EXTRA_BIND
#endif
...
#endif /* CPR__GLFW_WINDOW_EXTRA_BIND */
...
#endif /* CPR__GLFW_MONITOR_MODE_BIND */
...
#endif /* CPR__GLFW_MOUSE_BIND */

#if defined(CPR__GLFW_CREATE_CURSOR_BIND)
/* @param buffer
 * @param width
 * @param height
 * @param xhot
...
#endif
#if defined(CPR__GLFW_MOUSE_BIND) || defined(CPR__GLFW_MOUSE_CALLBACK_BIND)
  /* Mouse buttons */
